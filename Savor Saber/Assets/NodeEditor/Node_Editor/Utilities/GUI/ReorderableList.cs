...
namespace Gameflow
{
    namespace GUIUtilities
    {
        ...
        {
            public static readonly ConnectionKnobAttribute KnobAttributeOUT = new ConnectionKnobAttribute("OUT", NodeEditorFramework.Direction.Out, "Gameflow", ConnectionCount.Single, NodeSide.Right);
            public static readonly ConnectionKnobAttribute KnobAttributeIN = new ConnectionKnobAttribute("IN", NodeEditorFramework.Direction.In, "Gameflow", ConnectionCount.Multi, NodeSide.Left);
        }
