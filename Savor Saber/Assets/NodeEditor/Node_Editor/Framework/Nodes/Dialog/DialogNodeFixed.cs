...
namespace Gameflow
{
    [Node(false, "Dialog/Fixed", new System.Type[] { typeof(GameflowCanvas), typeof(DialogCanvas) })]
    public class DialogNodeFixed : DialogNode
    {
        #region Editor
        public const string ID = "Fixed Dialog Node";
        public override string GetID { get { return ID; } }

        public override string Title { get { return "Fixed Dialog"; } }
